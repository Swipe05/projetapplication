...
dict_data_sw = {"summonerName":"Swipe","123ID":[30,31,32,33,34],"Kill":[1,2,1,9,1],"Death":[1,2,18,0,1],"Assist":[1,2,19,17,17]}
def main():
    lmht = Data_base()
    lmht.drop_table("Partie")
    lmht.drop_table("all_summoner")
