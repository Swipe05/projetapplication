...
import calendar_DB
init_request = {'assists': 5, 'baronKills': 0, 'bountyLevel': 0, '12AssistStreakCount': 0, 'abilityUses': 161, 'acesBefore15Minutes': 0, 'alliedJungleMonsterKills': 8.000000029802322, 'baronTakedowns': 0, 'blastConeOppositeOpponentCount': 0, 'bountyGold': 0, 'buffsStolen': 1, 'completeSupportQuestInTime': 0, 'controlWardTimeCoverageInRiverOrEnemyHalf': 0.0180169684186807, 'controlWardsPlaced': 1, 'damagePerMinute': 1300.0442380168054, 'damageTakenOnTeamPercentage': 0.1458943410447822, 'dancedWithRiftHerald': 0, 'deathsByEnemyChamps': 2, 'dodgeSkillShotsSmallWindow': 74, 'doubleAces': 0, 'dragonTakedowns': 2, 'earliestBaron': 1320.8714699209593, 'earliestDragonTakedown': 655.2448687263736, 'earlyLaningPhaseGoldExpAdvantage': 0, 'effectiveHealAndShielding': 0, 'elderDragonKillsWithOpposingSoul': 0, 'elderDragonMultikills': 0, 'enemyChampionImmobilizations': 0, 'enemyJungleMonsterKills': 4, 'epicMonsterKillsNearEnemyJungler': 0, 'epicMonsterKillsWithin30SecondsOfSpawn': 0, 'epicMonsterSteals': 0, 'epicMonsterStolenWithoutSmite': 0, 'fastestLegendary': 960.258429460764, 'firstTurretKilledTime': 764.1561202735869, 'flawlessAces': 0, 'fullTeamTakedown': 0, 'gameLength': 1509.4821971643803, 'getTakedownsInAllLanesEarlyJungleAsLaner': 0, 'goldPerMinute': 598.6291463125465, 'hadAfkTeammate': 0, 'hadOpenNexus': 0, 'highestChampionDamage': 1, 'immobilizeAndKillWithAlly': 0, 'initialBuffCount': 0, 'initialCrabCount': 0, 'jungleCsBefore10Minutes': 0, 'junglerTakedownsNearDamagedEpicMonster': 0, 'kTurretsDestroyedBeforePlatesFall': 0, 'kda': 11, 'killAfterHiddenWithAlly': 2, 'killParticipation': 0.55, 'killedChampTookFullTeamDamageSurvived': 0, 'killingSprees': 2, 'killsNearEnemyTurret': 8, 'killsOnOtherLanesEarlyJungleAsLaner': 0, 'killsOnRecentlyHealedByAramPack': 0, 'killsUnderOwnTurret': 2, 'killsWithHelpFromEpicMonster': 0, 'knockEnemyIntoTeamAndKill': 0, 'landSkillShotsEarlyGame': 6, 'laneMinionsFirst10Minutes': 83, 'laningPhaseGoldExpAdvantage': 1, 'legendaryCount': 0, 'lostAnInhibitor': 0, 'maxCsAdvantageOnLaneOpponent': 51.00000002980232, 'maxKillDeficit': 0, 'maxLevelLeadLaneOpponent': 3, 'moreEnemyJungleThanOpponent': -119.00000008940697, 'multiKillOneSpell': 0, 'multiTurretRiftHeraldCount': 0, 'multikills': 6, 'multikillsAfterAggressiveFlash': 2, 'mythicItemUsed': 6673, 'outerTurretExecutesBefore10Minutes': 0, 'outnumberedKills': 6, 'outnumberedNexusKill': 0, 'perfectDragonSoulsTaken': 0, 'perfectGame': 0, 'pickKillWithAlly': 20, 'poroExplosions': 0, 'quickCleanse': 0, 'quickFirstTurret': 0, 'quickSoloKills': 0, 'riftHeraldTakedowns': 0, 'saveAllyFromDeath': 0, 'scuttleCrabKills': 1, 'skillshotsDodged': 141, 'skillshotsHit': 32, 'snowballsHit': 0, 'soloBaronKills': 0, 'soloKills': 1, 'soloTurretsLategame': 2, 'stealthWardsPlaced': 4, 'survivedSingleDigitHpCount': 0, 'survivedThreeImmobilizesInFight': 0, 'takedownOnFirstTurret': 1, 'takedowns': 22, 'takedownsAfterGainingLevelAdvantage': 0, 'takedownsBeforeJungleMinionSpawn': 0, 'takedownsFirstXMinutes': 8, 'takedownsInAlcove': 1, 'takedownsInEnemyFountain': 0, 'teamBaronKills': 1, 'teamDamagePercentage': 0.34648765994972486, 'teamElderDragonKills': 0, 'teamRiftHeraldKills': 2, 'thirdInhibitorDestroyedTime': 1412.4767967440857, 'threeWardsOneSweeperCount': 0, 'tookLargeDamageSurvived': 0, 'turretPlatesTaken': 3, 'turretTakedowns': 4, 'turretsTakenWithRiftHerald': 10, 'twentyMinionsIn3SecondsCount': 0, 'unseenRecalls': 0, 'visionScoreAdvantageLaneOpponent': 0.02472972869873047, 'visionScorePerMinute': 0.35182797954946976, 'wardTakedowns': 0, 'wardTakedownsBefore20M': 0, 'wardsGuarded': 1, 'champExperience': 13451, 'champLevel': 15, 'championId': 360, 'championName': 'Samira', 'championTransform': 0, 'consumablesPurchased': 2, 'damageDealtToBuildings': 3436, 'damageDealtToObjectives': 11065, 'damageDealtToTurrets': 3436, 'damageSelfMitigated': 25785, 'deaths': 2, 'detectorWardsPlaced': 1, 'doubleKills': 5, 'dragonKills': 1, 'eligibleForProgression': True, 'firstBloodAssist': False, 'firstBloodKill': False, 'firstTowerAssist': False, 'firstTowerKill': False, 'gameEndedInEarlySurrender': False, 'gameEndedInSurrender': False, 'goldEarned': 15060, 'goldSpent': 14775, 'individualPosition': 'BOTTOM', 'inhibitorKills': 1, 'inhibitorTakedowns': 2, 'inhibitorsLost': 0, 'item0': 6673, 'item1': 3047, 'item2': 3072, 'item3': 6333, 'item4': 3036, 'item5': 0, 'item6': 3340, 'itemsPurchased': 23, 'kills': 17, 'lane': 'BOTTOM', 'largestCriticalStrike': 549, 'largestKillingSpree': 12, 'largestMultiKill': 3, 'longestTimeSpentLiving': 1302, 'magicDamageDealt': 14568, 'magicDamageDealtToChampions': 4360, 'magicDamageTaken': 5666, 'neutralMinionsKilled': 20, 'nexusKills': 0, 'nexusLost': 0, 'nexusTakedowns': 0, 'objectivesStolen': 0, 'objectivesStolenAssists': 0, 'participantId': 4, 'pentaKills': 0, 'physicalDamageDealt': 123481, 'physicalDamageDealtToChampions': 27496, 'physicalDamageTaken': 13232, 'profileIcon': 3870, 'puuid': 'O_SL8qyYwLhQlMkIlV3zxDnF2XNYwZ4OmopHgy46mWEEYJSCarFH6_fR2hgRR5uzUhUcYdX7DGRd8A', 'quadraKills': 0, 'riotIdName': '', 'riotIdTagline': '', 'role': 'CARRY', 'sightWardsBoughtInGame': 0, 'spell1Casts': 106, 'spell2Casts': 12, 'spell3Casts': 31, 'spell4Casts': 12, 'summoner1Casts': 4, 'summoner1Id': 4, 'summoner2Casts': 5, 'summoner2Id': 3, 'summonerId': 'pAnlkbbND50iS0BFW5zlXIZ9Og2fSH8mi6gjeHjpr54pY07u', 'summonerLevel': 179, 'summonerName': 'EvangelineBe', 'teamEarlySurrendered': False, 'teamId': 100, 'teamPosition': 'BOTTOM', 'timeCCingOthers': 7, 'timePlayed': 1509, 'totalDamageDealt': 144792, 'totalDamageDealtToChampions': 32706, 'totalDamageShieldedOnTeammates': 0, 'totalDamageTaken': 20182, 'totalHeal': 2393, 'totalHealsOnTeammates': 0, 'totalMinionsKilled': 181, 'totalTimeCCDealt': 71, 'totalTimeSpentDead': 42, 'totalUnitsHealed': 1, 'tripleKills': 1, 'trueDamageDealt': 6742, 'trueDamageDealtToChampions': 850, 'trueDamageTaken': 1283, 'turretKills': 2, 'turretsLost': 1, 'unrealKills': 0, 'visionScore': 8, 'visionWardsBoughtInGame': 1, 'wardsKilled': 0, 'wardsPlaced': 5, 'win': True, 'timestamp': 1654960685.289, 'date': '06/11/2022 - 17:18:05'}
...
class LoLInterface:
    ...
    def __init__(self):
        self.database = Data_base("LienMinh2.db")
        # Api key needed to work with Riot Api
        self.api_key = 'RGAPI-804a584e-3752-4b62-878e-4da1da7f7b34'
        ...
        self.buscar_btn = Button(text="Add Player to Database", command=self.buscar_Invocador,
        ...
        self.loadbtn = Button(text="Recent Searches", command=self.make_calendar,
                            font=('Comic Sans MS', 14, 'bold'), background='#858aed')
    ...
    def make_calendar(self):
        ...
        if self.combo_player.get() == "" or self.combo_player.get().isspace() or self.combo.get() == "" or self.combo.get().isspace():
            ...
            try:
                ...
                calendar_DB.init_calendar(nameF)
        ...
        if self.text.get() == "" or self.text.get().isspace() or self.combo.get() == "" or self.combo.get().isspace():
            ...
            try:
                ...
                for j in range(10):
                    ...
                    pos = self.find_position_of_a_player(me["puuid"], liste_part_puid)
...
""")
    ...
    def save_list_Players(self):
        try:
            with open('players_list.txt', mode='a') as f:
                f.writelines(f"{self.text.get()}\n")
            f.close()
        except UnicodeEncodeError:
