...
dict_data_sw = {"summonerName":"Swipe","123ID":[302,318,325,335,345],"Kill":[1,2,1,9,1],"Death":[1,2,18,0,1],"Assist":[1,2,19,17,17]}
def main():
    ...
    lmht.read_data_from_a_dict(dict_data_max,name="partie",primary_key="[123ID]")
    lmht.read_data_from_a_dict(dict_data_max_update,name="partie" ,primary_key="[123ID]")

    lmht.read_data_from_a_dict(dict_data_max_update1,name="partie" ,primary_key="[123ID]")

    lmht.read_data_from_a_dict(dict_data_max_update2,name="partie" ,primary_key="[123ID]")

    lmht.read_data_from_a_dict(dict_data_max_update3,name="partie" ,primary_key="[123ID]")
    lmht.read_data_from_a_dict(dict_data_EP,name="partie" ,primary_key="[123ID]")
    lmht.read_data_from_a_dict(dict_data_sw,name="partie", primary_key="[123ID]")
    lmht.print_table_form_get_dict("partie")
    lmht.print_table_form_get_dict("all_summoner")
